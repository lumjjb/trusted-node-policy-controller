...
func TestReconcile(t *testing.T) {
	...
	instance := &policiesv1alpha1.TrustedNodePolicy{
		...
		Spec: policiesv1alpha1.TrustedNodePolicySpec{
	...
	// Create a ReconcileTrustedNodePolicy object with the scheme and fake client
	r := &ReconcileTrustedNodePolicy{client: cl, scheme: s, recorder: nil}
...
func TestCheckUnNamespacedPolicies(t *testing.T) {
	...
	var policies = map[string]*policiesv1alpha1.TrustedNodePolicy{}
...
func TestCheckViolationsPerNamespace(t *testing.T) {
	...
	var samplePolicySpec = policiesv1alpha1.TrustedNodePolicySpec{
		MaxRoleBindingUsersPerNamespace:  1,
...
func TestConvertPolicyStatusToString(t *testing.T) {
	...
	samplePolicyStatus := policiesv1alpha1.TrustedNodePolicyStatus{
...
func TestDeleteExternalDependency(t *testing.T) {
	...
	reconcileTrustedNodePolicy := ReconcileTrustedNodePolicy{
		client:   mgr.GetClient(),
		scheme:   mgr.GetScheme(),
		recorder: mgr.GetEventRecorderFor("samplepolicy-controller"),
	}
	reconcileTrustedNodePolicy.deleteExternalDependency(&samplePolicy)
}
